...
游戏名只能含有大小写英文字母、阿拉伯数字、下划线、英文句号.和减号-，长度2~16。基岩版玩家登陆时，会被自动加一个英文句号的前缀以示区分。
...
- **服务端版本:** 1.21.11 Fabric
- **IP地址:** `2ob.top:25565` (Java版), `2ob.top:19132` (基岩版)
- **最低支持Java游戏客户端版本** 1.21.5
- **推荐基岩版客户端版本** 1.21.131 [(此处下载)](https://mcapks.net/)
- **服务器位置:** 广东深圳
