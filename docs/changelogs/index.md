...
0. 开发服务器网站，制作登录系统与白名单验证系统
1. 玩家可以通过网站发表评论、建议或漏洞报告
2. 重构镐和剑的抽奖
3. 服主可以在网站内发布提案和专门的计划列表（而不是目前一个简陋的页面）
4. 可以通过网站查看玩家统计数据
5. 考虑对QQ或微信群机器人的支持
6. 增加空岛维度
7. 在B站提供新人入门指南视频。
8. 原QQ群的群主号被永久封禁，计划重建新群。并要求所有白名单玩家重新填写联系方式。
...
10. 服务器更新至 1.21.10，删除了大量空闲区块
~~11. 修复了快捷潜影盒复制物品的bug~~
11. 移除了快捷潜影盒
12. 移除了鞘翅配方，增加了鞘翅的抽奖概率
13. 假人下线后会显示操作者
14. 首次进服时显示_服务器行为准则_
15. 修复了新人无法进服的bug（来自[VMP](https://github.com/RelativityMC/VMP-fabric/issues/105)）
16. 恢复了某些误删的区块
17. 位移了一下整合包文档
18. 新增服务器信息展示页面
19. 增加_无法进服排查方案_文档
